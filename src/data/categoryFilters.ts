...
export const ACCOUNT_ORIGIN_OPTIONS = [
  'Личный', 'Первый владелец', 'Перепродажа', 'Куплен у владельца', 'Фарм', 'Авторег', 'Ручная регистрация',
  'Старый личный', 'Подарок', 'Семейный аккаунт', 'Восстановленный', 'Неизвестно', 'С гарантией происхождения'
];
