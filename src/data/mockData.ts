...
export const accounts: Account[] = [
  {
    ...
    seller: { id: 's1', username: 'NightDealer', rating: 4.9 } as any,
    tags: [{ label: 'Prime', icon: '⭐' }],
    riskLevel: 'low', hasOriginalEmail: true, hasTempEmail: true,
    lastLogin: '3 дня назад', country: 'Россия', gamesCount: 47,
    guarantee: true, guaranteeHours: 24, createdAt: '2024-11-15'
  },
  {
    id: 'a2', title: 'Fortnite OG | Rare Skins | Full Access', category: 'fortnite',
    price: 3200, currency: 'RUB',
    seller: { id: 's2', username: 'ShadowMarket', rating: 4.7 } as any,
    tags: [{ label: 'OG', icon: '💎' }],
    riskLevel: 'low', hasOriginalEmail: false, hasTempEmail: true,
    lastLogin: '1 день назад', country: 'USA',
    guarantee: true, guaranteeHours: 24, createdAt: '2024-12-01'
  }
];
