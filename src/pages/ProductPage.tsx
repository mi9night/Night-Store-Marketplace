...
const ProductPage: React.FC<ProductPageProps> = ({ account, setCurrentPage, onAddToCart }) => {
  ...
  const reviewBlockClass = myReview
    ? (myReview.positive ? 'from-green-900/20 to-purple-900/10 border-green-700/30' : 'from-red-900/20 to-purple-900/10 border-red-700/30')
    : (!revPositive && showReview
      ? 'from-red-900/20 to-purple-900/10 border-red-700/30'
      : 'from-green-900/20 to-purple-900/10 border-green-700/30');
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          {myOrder && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.18 }}
              className={`bg-gradient-to-br ${reviewBlockClass} border rounded-2xl p-5 transition-colors duration-200`}>
